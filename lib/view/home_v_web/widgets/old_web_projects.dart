...
//                                 //CarouselWithIndicator(imgList: item.appScreens)
...
//                             GestureDetector(
//                               onTap: () {
//                                 launchWithUri(url: item.projectUrl);
//                               },
//                               child: kIsWeb
//                                   ? HoverUnderlineText(
//                                       text: item.projectTitle, textStyle: const TextStyle(fontWeight: FontWeight.bold, fontSize: 24))
//                                   : Text(item.projectTitle, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 24)),
//                             ),
//                             const Gap(8),
//                             Text(item.projectDescription, style: const TextStyle(fontWeight: FontWeight.w500, fontSize: 16)),
//                             const Gap(24),
